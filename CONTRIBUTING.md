# Contributing to PETML

Thank you for investing your time in contributing to PETML!

Read our [Code of Coduct](./CODE_OF_CONDUCT.md) to keep our community approachable and respectable.

This guide details how to use issues and pull requests to improve PETML.
...
If you spot a problem with the problem, [search if an issue already exists](https://github.com/tiktok-privacy-innovation/PETML/issues). If a related issue doesn't exist, you can open a new issue using [issue template](https://github.com/tiktok-privacy-innovation/PETML/issues/new/choose).
